...
const styles = StyleSheet.create({
  ...
  pageTitle: { fontSize: 20, fontFamily: fontFamily.extrabold, color: colors.text, marginBottom: 10, letterSpacing: -0.3 },
  ...
  rangeChipText: { fontSize: 12.5, fontFamily: fontFamily.semibold, color: colors.text },
  rangeChipTextActive: { color: colors.primaryText },
  sectionTitle: { fontSize: 15, fontFamily: fontFamily.extrabold, color: colors.text, marginTop: 18, marginBottom: 8 },
  card: {
    backgroundColor: colors.surface,
    borderRadius: 16,
    padding: 16,
  ...
  rankBadge: { fontSize: 12, fontFamily: fontFamily.extrabold, color: colors.textMuted, width: 22 },
  barLabel: { width: 92, fontSize: 12, color: colors.text, fontFamily: fontFamily.semibold },
  barTrack: { flex: 1, height: 10, borderRadius: 5, backgroundColor: colors.border, overflow: 'hidden' },
  barFill: { height: '100%', borderRadius: 5 },
  barValue: { width: 30, fontSize: 12, fontFamily: fontFamily.bold, color: colors.text, textAlign: 'right' },
  totalHint: { fontSize: 12, fontFamily: fontFamily.medium, color: colors.textMuted, marginTop: 2 },
  terminalBlock: { gap: 4 },
  terminalMeta: { fontSize: 11, fontFamily: fontFamily.medium, color: colors.textMuted, marginLeft: 100 },
  exportButton: {
    flex: 1,
  ...
  exportButtonText: { color: '#fff', fontFamily: fontFamily.bold },
