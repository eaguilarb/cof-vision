...
const styles = StyleSheet.create({
  ...
  ageText: { fontSize: 12, fontFamily: fontFamily.medium, color: colors.textMuted, fontStyle: 'italic' },
  metaLine: { fontSize: 12.5, color: colors.textMuted, marginTop: 6, fontFamily: fontFamily.semibold },
  code: { fontSize: 12, color: colors.textMuted, fontFamily: fontFamily.bold },
  title: { fontSize: 21, fontFamily: fontFamily.extrabold, color: colors.text, marginTop: 4, marginBottom: 8, letterSpacing: -0.3 },
  sectionTitle: { fontSize: 13, fontFamily: fontFamily.extrabold, color: colors.text, marginTop: 18, marginBottom: 6 },
  text: { fontSize: 14, fontFamily: fontFamily.regular, color: colors.text, lineHeight: 20 },
  hint: { fontSize: 12, fontFamily: fontFamily.medium, color: colors.textMuted },
  error: { color: colors.danger, marginTop: 12, fontSize: 13, fontFamily: fontFamily.medium },
  ...
  noteAuthor: { fontSize: 12, fontFamily: fontFamily.bold, color: colors.primary, marginBottom: 2 },
  ...
  noteButtonText: { color: '#fff', fontFamily: fontFamily.bold },
  historyLine: { fontSize: 12, fontFamily: fontFamily.medium, color: colors.textMuted, marginBottom: 4 },
  deleteCaseButton: {
    marginTop: 28,
  ...
  deleteCaseButtonText: { color: colors.danger, fontFamily: fontFamily.bold, fontSize: 14 },
  ...
  photoDeleteText: { color: '#fff', fontSize: 11, fontFamily: fontFamily.bold },
  photoAddButton: {
    width: 72,
    height: 72,
    borderRadius: 12,
  ...
  resolutionBox: {
    backgroundColor: `${statusColors.resolved}12`,
    borderRadius: 12,
    padding: 12,
    marginTop: 12,
    gap: 2,
  },
  resolutionTitle: { fontSize: 12, fontFamily: fontFamily.bold, color: statusColors.resolved, marginBottom: 2 },
  ...
  resolveModalTitle: { fontSize: 17, fontFamily: fontFamily.extrabold, color: colors.text, marginBottom: 6 },
  ...
  resolveCancelButtonText: { color: colors.text, fontFamily: fontFamily.bold },
  ...
  resolveConfirmButtonText: { color: '#fff', fontFamily: fontFamily.bold },
});
