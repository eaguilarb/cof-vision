    ...
    <div className="video-page">
      <section className="panel">
        ...
        <p className="muted">
          ...
          envía el video a ningún servidor ni se necesita API key ni pagar nada. Si el archivo trae
          coordenadas GPS embebidas, se muestran en el mapa.
        </p>
            ...
            <div className="video-side">
              ...
              {modelState.status === 'loading' && (
                <div className="model-progress">
                  <span>
                    Descargando modelo de descripción (una sola vez, gratis, queda en caché del navegador)
